...
Importe o arquivo **sql/livrocaixa.sql** em seu gerenciador de banco de dados do MySQL e modifique o arquivo **includes/config.php** com o usuário e a senha do seu banco.
